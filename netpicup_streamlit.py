...
if st.session_state.pagecategoly == 0:
    ...
    for colum_i in range(0,10,2):
        ...
        itempage[colum_i]=left_column.button(text[colum_i], width=100)
        itempage[colum_i+1]=right_column.button(text[colum_i+1], width=100)
    if itempage[0]:
...
if st.session_state.pagecategoly == 1:
    ...
    p_title=str(st.session_state.itemserch_word)
